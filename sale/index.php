...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_LINK_STAFF_ID" => "118",
		"IBLOCK_LINK_VACANCIES_ID" => "104",
		"IBLOCK_LINK_PROJECTS_ID" => "117",
		"IBLOCK_LINK_BRANDS_ID" => "132",
		...
		"IBLOCK_LINK_SERVICES_ID" => "124",
		"IBLOCK_LINK_TIZERS_ID" => "112",
		"BLOCK_VACANCY_NAME" => "Вакансии",
		"BLOCK_BLOG_NAME" => "Статьи",
		"IBLOCK_LINK_VACANCY_ID" => "104",
		"IBLOCK_LINK_BLOG_ID" => "119",
