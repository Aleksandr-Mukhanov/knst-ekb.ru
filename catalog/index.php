...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PAGER_SHOW_ALL" => "N",
		"IBLOCK_STOCK_ID" => "126",
		"IBLOCK_LINK_NEWS_ID" => "122",
		"IBLOCK_SERVICES_ID" => "124",
		"IBLOCK_TIZERS_ID" => "112",
		"IBLOCK_LINK_REVIEWS_ID" => "121",
		"STAFF_IBLOCK_ID" => "118",
		"VACANCY_IBLOCK_ID" => "104",
		"SHOW_QUANTITY" => "Y",
		"SHOW_MEASURE" => "Y",
		...
		"DETAIL_EXPANDABLES_TITLE" => "Покупают вместе",
		...
		"VIEW_BLOCK_TYPE" => "N",
		"SHOW_HOW_BUY" => "Y",
		"TITLE_HOW_BUY" => "Как заказать",
		"SHOW_DELIVERY" => "Y",
		"TITLE_DELIVERY" => "Доставка и сборка",
		"SHOW_PAYMENT" => "Y",
		...
		"LANDING_IBLOCK_ID" => "131",
		"DETAIL_BLOCKS_TAB_ORDER" => "desc,delivery,buy,reviews,char,stores,video,payment,custom_tab",
