    ...
    <div class="wrap">
        <div class="hero__inner" style="background-color: #365EDC;">
            <div class="hero__text">
                ...
                <div class="button"><a href="/catalog/" class="btn btn-yellow" data-event="jqm" data-param-form_id="PRICE_CALC" data-name="PRICE_CALC" onclick="goModalCustom()">подобрать оборудование</a></div>
            </div>
        ...
        <div class="instock-main__inner">
            <div class="constanta">
                <div class="constanta__logo">
                    ...
                    <div class="button m-show"><a href="#" class="btn" data-event="jqm" data-param-form_id="DOWNLOAD_CATALOG" data-name="DOWNLOAD_CATALOG" onclick="goModalCustom()">скачать каталог</a></div>
                ...
                <div class="button"><a href="#" class="btn" data-event="jqm" data-param-form_id="DOWNLOAD_CATALOG" data-name="DOWNLOAD_CATALOG" onclick="goModalCustom()">скачать каталог</a></div>
...
<section class="feedback2">
    <div class="wrap">
        <div class="feedback2__inner">
            ...
            <div class="button"><a href="#" class="btn" data-event="jqm" data-param-form_id="PRICE_CALC" data-name="PRICE_CALC" onclick="goModalCustom()">заказать расчет</a></div>
        </div>
    </div>
</section>
