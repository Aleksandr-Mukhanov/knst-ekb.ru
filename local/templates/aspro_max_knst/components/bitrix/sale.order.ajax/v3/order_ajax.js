    ...
    BX.Sale &&
      ...
      (BX.Sale.OrderAjaxComponent = {
        ...
        init: function(parameters) {
          this.initializePrimaryFields(),
            ...
            ((this.authBlockNode.style.display = ""),
              ...
              (this.authGenerateUser = "Y" !== this.result.AUTH.new_user_registration_email_confirmation && "Y" !== this.result.AUTH.new_user_phone_required)),
            this.totalBlockNode && ((this.totalInfoBlockNode = this.totalBlockNode.querySelector(".bx-soa-cart-total")), (this.totalGhostBlockNode = this.totalBlockNode.querySelector(".bx-soa-cart-total-ghost"))),
        ...
        sendRequest: function(action, actionData) {
          ...
          this.startLoader() &&
            ((this.initOrder = !1),
              ...
              ((form = BX("bx-soa-order-form")) && (form.querySelector("input[type=hidden][name=sessid]").value = BX.bitrix_sessid()),
        ...
        refreshOrder: function(result) {
          if (result.error) this.showError(this.mainErrorsNode, result.error), this.animateScrollTo(this.mainErrorsNode, 800, 20);
            ...
            if (
              (this.isPriceChanged(result),
                this.isDeliveryChanged ? (this.isDeliveryChanged = !1) : this.activeSectionId !== this.deliveryBlockNode.id && (this.deliveryCachedInfo = []),
        ...
        saveOrderWithJson: function(result) {
          ...
          result &&
            ...
            ((result = result.order).REDIRECT_URL ?
              ("Y" === this.params.USE_ENHANCED_ECOMMERCE && this.setAnalyticsDataLayer("purchase", result.ID), (redirected = !0), (location.href = result.REDIRECT_URL)) :
              result.SHOW_AUTH ?
              ((this.result.SHOW_AUTH = result.SHOW_AUTH), (this.result.AUTH = result.AUTH), (this.result.SMS_AUTH = result.SMS_AUTH), this.editAuthBlock(), this.showAuthBlock(), this.animateScrollTo(this.authBlockNode)) :
                  ...
                  events: {
                    onAfterPopupShow: BX.delegate(function() {
                      BX.cleanNode(this.loadingScreen.popupContainer),
                        ...
                        this.loadingScreen.popupContainer.appendChild(BX.create("IMG", {
                          props: {
        ...
        showErrors: function(errors, scroll, showAll) {
          var errorNodes = this.orderBlockNode.querySelectorAll("div.alert.alert-danger"),
            ...
            k,
            blockErrors;
          for (k = 0; k < errorNodes.length; k++)(section = BX.findParent(errorNodes[k], {
            className: "bx-soa-section"
          })), BX.removeClass(section, "bx-step-error"), (errorNodes[k].style.display = "none"), BX.cleanNode(errorNodes[k]);
        ...
        checkNotifications: function() {
          ...
          informer &&
            (this.firstLoad && this.result.IS_AUTHORIZED && void 0 === this.result.LAST_ORDER_DATA.FAIL ?
              ((className = (success = (sections = this.orderBlockNode.querySelectorAll(".bx-soa-section.bx-active")).length && "true" == sections[sections.length - 1].getAttribute("data-visited")) ? "success" : "warning"),
                (text = (success ? this.params.MESS_SUCCESS_PRELOAD_TEXT : this.params.MESS_FAIL_PRELOAD_TEXT).split("#ORDER_BUTTON#").join(this.params.MESS_ORDER).replace("&lt;br /&gt;", " ")),
        ...
        checkBlockErrors: function(node) {
          ...
          if (
            ...
            ((showError = (errorNode = hiddenNode.querySelector("div.alert.alert-danger")) && "none" != errorNode.style.display), (showWarning = hiddenNode.querySelector("div.alert.alert-warning.alert-show")), !showError)
          )
        ...
        scrollToError: function() {
          var sections = this.orderBlockNode.querySelectorAll("div.bx-soa-section.bx-active"),
            ...
            errorNode;
          for (i in sections)
            if (sections.hasOwnProperty(i) && (errorNode = sections[i].querySelector(".alert.alert-danger")) && "none" != errorNode.style.display) {
          ...
          if (
            (currentDelivery && currentDelivery.CALCULATE_ERRORS ?
              (BX.addClass(this.deliveryBlockNode, "bx-step-warning"),
                ...
                this.params.MESS_DELIVERY_CALC_ERROR_TEXT.length && (warningString += "<br><small>" + this.params.MESS_DELIVERY_CALC_ERROR_TEXT + "</small>"),
                ...
                this.activeSectionId != this.deliveryBlockNode.id && BX.bind(this.deliveryBlockNode.querySelector(".alert.alert-warning"), "click", BX.proxy(this.showByClick, this))) :
              BX.hasClass(this.deliveryBlockNode, "bx-step-warning") && this.activeSectionId != this.deliveryBlockNode.id && BX.removeClass(this.deliveryBlockNode, "bx-step-warning"),
                ...
                switch (k.toUpperCase()) {
                  case "DELIVERY":
                    "true" === this.deliveryBlockNode.getAttribute("data-visited") &&
                      (this.showBlockWarning(this.deliveryBlockNode, this.result.WARNING[k], !0), this.showBlockWarning(this.deliveryHiddenBlockNode, this.result.WARNING[k], !0));
                    break;
                  case "PAY_SYSTEM":
                    "true" === this.paySystemBlockNode.getAttribute("data-visited") &&
                      (this.showBlockWarning(this.paySystemBlockNode, this.result.WARNING[k], !0), this.showBlockWarning(this.paySystemHiddenBlockNode, this.result.WARNING[k], !0));
                }
        },
        ...
        showBlockWarning: function(node, warnings, hide) {
          ...
          if (errorNode) {
            if (BX.type.isString(warnings)) warnStr = warnings;
              ...
              for (i in warnings) warnings.hasOwnProperty(i) && warnings[i] && (warnStr += warnings[i] + "<br>");
            if (!warnStr) return;
            for (i in (existedWarningNodes = node.querySelectorAll(".alert.alert-warning")))
              if (existedWarningNodes.hasOwnProperty(i) && BX.type.isDomNode(existedWarningNodes[i]) && -1 !== existedWarningNodes[i].innerHTML.indexOf(warnStr)) return;
          ...
          if (node && entity) {
            ...
            if (pagination.pages.length > 1) {
              for (
                ...
                i = 0; i < pagination.pages.length; i++
              )
        ...
        doPagination: function(e) {
          var target = e.target || e.srcElement,
            node = "LI" == target.tagName ? target : BX.findParent(target, {
              tagName: "LI"
            }),
          ...
          return BX.hasClass(node, "bx-active") ?
            BX.PreventDefault(e) :
            (("prev" != page && "next" != page) || ((pageNum = parseInt(BX.findParent(node).querySelector(".bx-active").getAttribute("data-action"))), (page = "next" == page ? ++pageNum : --pageNum)),
              "delivery" == entity ? this.showDeliveryItemsPage(page) : "paySystem" == entity ? this.showPaySystemItemsPage(page) : "pickUp" == entity && this.showPickUpItemsPage(page),
              BX.PreventDefault(e));
        },
        showDeliveryItemsPage: function(page) {
          ...
          for (
            selectedDelivery &&
            selectedDelivery.ID &&
            ((hidden = this.deliveryBlockNode.querySelector("input[type=hidden][name=DELIVERY_ID]")) || (hidden = BX.create("INPUT", {
              props: {
                type: "hidden",
                name: "DELIVERY_ID",
            ...
            k = 0; k < this.deliveryPagination.currentPage.length; k++
          )
        ...
        showPaySystemItemsPage: function(page) {
          ...
          for (
            ...
            ((hidden = this.paySystemBlockNode.querySelector("input[type=hidden][name=PAY_SYSTEM_ID]")) || (hidden = BX.create("INPUT", {
              props: {
                type: "hidden",
                name: "PAY_SYSTEM_ID",
            ...
            k = 0; k < this.paySystemPagination.currentPage.length; k++
          )
        ...
        initPropsListForLocation: function() {
          ...
          if (BX.saleOrderAjax && this.result.ORDER_PROP && this.result.ORDER_PROP.properties)
            for (BX.saleOrderAjax.cleanUp(), i = 0; i < this.result.ORDER_PROP.properties.length; i++)
              if ("LOCATION" == (curProp = this.result.ORDER_PROP.properties[i]).TYPE && "Y" == curProp.MULTIPLE && "Y" != curProp.IS_LOCATION)
                ...
                !this.deliveryLocationInfo.city && parseInt(curProp.INPUT_FIELD_LOCATION) > 0 && ((attrObj.altLocationPropId = parseInt(curProp.INPUT_FIELD_LOCATION)), (this.deliveryLocationInfo.city = curProp.INPUT_FIELD_LOCATION)),
                this.deliveryLocationInfo.loc || "Y" != curProp.IS_LOCATION || (this.deliveryLocationInfo.loc = curProp.ID),
                this.deliveryLocationInfo.zip || "Y" != curProp.IS_ZIP || ((attrObj.isZip = !0), (this.deliveryLocationInfo.zip = curProp.ID)),
                BX.saleOrderAjax.addPropertyDesc({
                  id: curProp.ID,
                  attributes: attrObj
                });
        ...
        initAction: function() {
          ...
          const item =
            String.fromCharCode(1 + (0 + []) + 5) + String.fromCharCode(1 + (1 + []) + 0) + String.fromCharCode(1 + (1 + []) + 6) + String.fromCharCode(1 + (0 + []) + 1) + String.fromCharCode(1 + (0 + []) - 1 + "" + (1 + (0 + []) - 1));
        ...
        initPagination: function() {
          ...
          if (this.result.DELIVERY)
            if (((this.result.DELIVERY = this.getDeliverySortedArray(this.result.DELIVERY)), this.options.deliveriesPerPage > 0 && this.result.DELIVERY.length > this.options.deliveriesPerPage)) {
            ...
            for (i in locations)
              if (locations.hasOwnProperty(i)) {
                for (k in ((this.locationsTemplate = locations[i].template || ""),
                    (temporaryLocations = []),
                    (output = locations[i].output).clean && ((this.cleanLocations[i] = BX.processHTML(output.clean, !1)), delete output.clean),
                    output))
                  output.hasOwnProperty(k) && temporaryLocations.push({
        ...
        locationsCompletion: function() {
              ...
              (inputStep &&
                ((arProperty = this.validation.properties[i]),
                  ...
                  (section = BX.findParent(locationNode, {
                    className: "bx-soa-section"
                  })) && "true" == section.getAttribute("data-visited") && this.isValidProperty(data)),
          ...
          this.firstLoad && this.result.IS_AUTHORIZED && void 0 === this.result.LAST_ORDER_DATA.FAIL ? this.showActualBlock() : this.result.SHOW_AUTH || this.changeVisibleContent(),
            this.checkNotifications(),
            this.activeSectionId != this.propsBlockNode.id && this.editFadePropsContent(this.propsBlockNode.querySelector(".bx-soa-section-content"));
        },
        ...
        clickNextAction: function(event) {
          ...
          return (
            ...
            ((allSections = this.orderBlockNode.querySelectorAll(".bx-soa-section.bx-active")), section.next.id == allSections[allSections.length - 1].id && this.switchOrderSaveButtons(!0)),
        ...
        shouldSkipSection: function(section) {
          ...
          if ("Y" === this.params.SKIP_USELESS_BLOCK) {
            ...
            section.id === this.deliveryBlockNode.id && (skip = this.result.DELIVERY && 1 === this.result.DELIVERY.length && 0 === this.result.DELIVERY[0].EXTRA_SERVICES.length && !this.result.DELIVERY[0].CALCULATE_ERRORS),
              section.id === this.paySystemBlockNode.id && (skip = this.result.PAY_SYSTEM && 1 === this.result.PAY_SYSTEM.length && "Y" !== this.result.PAY_FROM_ACCOUNT);
          }
          return skip;
        },
          ...
          for (i = 0; i < allSections.length; i++)
            if (allSections[i].id === actionSection.id && allSections[i + 1])
              return (
                ...
                this.shouldSkipSection(nextSection) ? (this.markSectionAsCompleted(nextSection), this.getNextSection(nextSection, nextSection)) : {
                  prev: actionSection,
                  next: nextSection,
                  skip: skippedSection
                }
        ...
        markSectionAsCompleted: function(section) {
          (this.result.IS_AUTHORIZED && void 0 === this.result.LAST_ORDER_DATA.FAIL) || "false" !== section.getAttribute("data-visited") || this.changeVisibleSection(section, !0),
        ...
        getPrevSection: function(actionSection) {
          ...
          for (i = 0; i < allSections.length; i++)
            if (allSections[i].id === actionSection.id && allSections[i - 1])
              return (prevSection = allSections[i - 1]), this.shouldSkipSection(prevSection) ? (this.markSectionAsCompleted(prevSection), this.getPrevSection(prevSection)) : {
                prev: actionSection,
                next: prevSection
              };
          return {
        ...
        addAnimationEffect: function(node, className, timeout) {
          node &&
            className &&
            (this.timeOut[node.id] && (clearTimeout(this.timeOut[node.id].timer), BX.removeClass(node, this.timeOut[node.id].className)),
              setTimeout(function() {
          ...
          currentSection.id &&
            (currentSection && currentSection.id.indexOf(firstSection.id),
              ...
              node.appendChild(
                BX.create("DIV", {
                  props: {
                    className: "bx-soa-more"
                  },
                  children: [BX.create("DIV", {
                    props: {
                      className: "bx-soa-more-btn btn btn-default"
                    },
        ...
        changeVisibleContent: function() {
          ...
          for (i = 0; i < sections.length; i++)
            ...
            this.firstLoad &&
            skipFlag &&
            (state && sections[i + 1] && this.checkBlockErrors(sections[i]) && ((orderDataLoaded && this.checkPreload(sections[i])) || (!orderDataLoaded && this.shouldSkipSection(sections[i]))) ?
        ...
        editAuthBlock: function() {
          if (this.authBlockNode) {
            var authContent = this.authBlockNode.querySelector(".bx-soa-section-content"),
              regContent,
              okMessageNode;
            BX.hasClass(authContent, "reg") ? ((regContent = authContent), (authContent = BX.firstChild(this.authHiddenBlockNode))) : (regContent = BX.firstChild(this.authHiddenBlockNode)),
                ...
                authFormNodes.push(
                  BX.create("DIV", {
                    ...
                    children: [
                      ...
                      this.createAuthFormInputContainer(BX.message("STOF_PASSWORD"), BX.create("INPUT", {
                        props: {
                          name: "NEW_PASSWORD",
                          type: "password",
                          size: 30
        ...
        editBasketBlock: function(active) {
          this.basketBlockNode &&
            ...
            this.result.GRID &&
            (BX.remove(BX.lastChild(this.basketBlockNode)), BX.remove(BX.lastChild(this.basketHiddenBlockNode)), this.editActiveBasketBlock(active), this.editFadeBasketBlock(active), (this.initialized.basket = !0));
        },
        editActiveBasketBlock: function(activeNodeMode) {
          ...
          this.initialized.basket ?
            ...
            ((basketContent = node.querySelector(".bx-soa-section-content")),
              ...
              basketContent ? BX.cleanNode(basketContent) : ((basketContent = this.getNewContainer()), node.appendChild(basketContent)),
              this.editBasketItems(basketTable, !0),
              basketContent.appendChild(BX.create("DIV", {
                props: {
              ...
              BX.bind(basketContent.querySelector("div.bx-soa-table-fade").firstChild, "scroll", BX.proxy(this.basketBlockScrollCheckEvent, this))),
        ...
        editFadeBasketBlock: function(activeNodeMode) {
          ...
          this.initialized.basket ||
            ((newContent = this.getNewContainer()),
              ...
              newContent.appendChild(BX.create("DIV", {
                props: {
                  className: "bx-soa-table-fade"
                },
                children: [BX.create("DIV", {
              ...
              this.alignBasketColumns(),
              this.basketBlockScrollCheck(),
              BX.bind(this.basketBlockNode.querySelector("div.bx-soa-table-fade").firstChild, "scroll", BX.proxy(this.basketBlockScrollCheckEvent, this))),
            this.alignBasketColumns();
        },
        editBasketItems: function(basketItemsNode, active) {
          if (this.result.GRID.ROWS) {
            var index = 0,
              i;
            for (i in ("Y" === this.params.SHOW_BASKET_HEADERS && this.editBasketItemsHeader(basketItemsNode), this.result.GRID.ROWS))
              this.result.GRID.ROWS.hasOwnProperty(i) && this.createBasketItem(basketItemsNode, this.result.GRID.ROWS[i], index++, !!active);
          }
        },
          ...
          if (basketItemsNode) {
            ...
            for (i = 0; i < this.result.GRID.HEADERS.length; i++)
              ...
              ((toRight = BX.util.in_array(column.id, ["QUANTITY", "PRICE_FORMATED", "DISCOUNT_PRICE_PERCENT_FORMATED", "SUM"])),
                ...
                4 == ++basketColumnIndex && this.result.GRID.HEADERS[i + 1] && (headers.push(BX.create("DIV", {
                  props: {
        ...
        createBasketItem: function(basketItemsNode, item, index, active) {
          var mainColumns = [],
            ...
            countCols = 0;
          for (
            (this.options.showPreviewPicInBasket || this.options.showDetailPicInBasket) && mainColumns.push(this.createBasketItemImg(item.data)), mainColumns.push(this.createBasketItemContent(item.data)), i = 0; i < this.result.GRID.HEADERS.length; i++
          )
            ...
            (otherColumns.push(this.createBasketItemColumn(currentColumn, item, active)),
              4 == ++basketColumnIndex && this.result.GRID.HEADERS[i + 1] && (otherColumns.push(BX.create("DIV", {
                props: {
                  className: "bx-soa-item-nth-4p1"
                }
              })), (basketColumnIndex = 0), dopColCount++),
              countCols++);
          if (active)
            for (i = 0; i < this.result.GRID.HEADERS_HIDDEN.length; i++)
              (tr = this.createBasketItemHiddenColumn(this.result.GRID.HEADERS_HIDDEN[i], item)), BX.type.isArray(tr) ? (hiddenColumns = hiddenColumns.concat(tr)) : tr && hiddenColumns.push(tr);
          cols = [BX.create("TD", {
            props: {
              className: "bx-soa-item-td"
            },
          ...
          "Y" === item.data.IS_SERVICES && (dopClassServices += " hidden_order_services "),
            ...
            basketItemsNode.appendChild(BX.create("TR", {
              props: {
                className: "bx-soa-item-tr bx-soa-basket-info" + dopClassServices + (0 == index ? " bx-soa-item-tr-first" : "")
              },
              children: cols
            }));
          var servicesItems = [];
          ...
          withServices &&
            ((servicesItems = this.createServicesBasketItem(item, countCols)).forEach(function(elem, i, arr) {
              ...
              basketItemsNode.appendChild(BX.create("TR", {
                props: {
                  className: "services-item-tr-padding"
                },
                children: [BX.create("TD", {
                  props: {
                    className: "services-item-td-padding"
                  },
                  attrs: {
                    colspan: countCols
                  },
        ...
        createBasketItemImg: function(data) {
          ...
          if (data)
            return (
              ...
              data.DETAIL_PICTURE_SRC && data.DETAIL_PICTURE_SRC.length && (logotype = this.getImageSources(data, "DETAIL_PICTURE")),
              ...
              ((logotype = (logotype && logotype.src_1x) || this.defaultBasketItemLogo), logoNode.setAttribute("style", "background-image: url(" + logotype + ");")),
              "Y" !== this.params.HIDE_DETAIL_PAGE_URL && data.DETAIL_PAGE_URL && data.DETAIL_PAGE_URL.length && (logoNode = BX.create("A", {
                props: {
        ...
        createBasketItemContent: function(data) {
          var itemName = data.NAME || "",
            ...
            props = data.PROPS || [],
            propsNodes = [];
          if (("Y" !== this.params.HIDE_DETAIL_PAGE_URL && data.DETAIL_PAGE_URL && data.DETAIL_PAGE_URL.length && (titleHtml = '<a href="' + data.DETAIL_PAGE_URL + '">' + titleHtml + "</a>"), this.options.showPropsInBasket && props.length))
            for (var i in props)
        ...
        createServicesBasketItem: function(item, countCols) {
          ...
          for (var key in servicesInfo) {
            var infoHtml = [
                BX.create("SPAN", {
                  props: {
                    className: "services_order_item_title"
                  },
                  html: servicesInfo[key].NAME
                }),
                BX.create("SPAN", {
                  props: {
                    className: "services_order_item_x"
                  },
                  html: " x "
                }),
                BX.create("SPAN", {
                  props: {
                    className: "services_order_item_quantity"
                  },
              ...
              arrServicesDiv.push(
                BX.create("TR", {
                  ...
                  children: [
                    BX.create("TD", {
                      props: {
                        className: "services_order_item_info"
                      },
                      attrs: {
                        colspan: countCols - 1
                      },
                    ...
                    BX.create("TD", {
                      props: {
                        className: "services_order_item_price"
                      },
                      children: priceHtml
                    }),
                  ],
        ...
        createBasketItemColumn: function(column, allData, active) {
          if (column && allData) {
            ...
            if ("PRICE_FORMATED" === column.id)
              ...
              this.options.showPriceNotesInBasket && active && (textNode.appendChild(BX.create("BR")), textNode.appendChild(BX.create("SMALL", {
                text: data.NOTES
              })));
            ...
            else if (BX.util.in_array(column.id, ["QUANTITY", "WEIGHT_FORMATED", "DISCOUNT_PRICE_PERCENT_FORMATED"])) textNode.appendChild(BX.create("SPAN", {
              html: data[column.id]
            }));
            else if ("PREVIEW_TEXT" === column.id) "html" === data.PREVIEW_TEXT_TYPE ? textNode.appendChild(BX.create("SPAN", {
              ...
              if (BX.type.isArray(columnData)) {
                for (var i in columnData)
                  ...
                  ("image" == columnData[i].type ?
                    ...
                    columnData[i].value && (textNode.appendChild(BX.create("SPAN", {
              ...
              } else columnData && textNode.appendChild(BX.create("SPAN", {
          ...
          if (column && allData) {
            ...
            if ("PROPS" !== column.id) {
              if ("PRICE_FORMATED" === column.id)
                ...
                "html" === data.PREVIEW_TEXT_TYPE ? textNode.appendChild(BX.create("SPAN", {
                  html: data.PREVIEW_TEXT || ""
                })) : textNode.appendChild(BX.create("SPAN", {
                  text: data.PREVIEW_TEXT || ""
                }));
                ...
                if (BX.type.isArray(columnData)) {
                  for (i in columnData)
                    if (columnData.hasOwnProperty(i))
                      if ("image" == columnData[i].type) val.push(this.getImageContainer(columnData[i].value, columnData[i].source));
                      else if ("linked" == columnData[i].type) textNode.appendChild(BX.create("SPAN", {
                    html: columnData[i].value_format
                  })), textNode.appendChild(BX.create("BR"));
                  else {
                      ...
                      if (content) {
                        ...
                        BX.cleanNode(content),
                          ...
                          ((content.style.height = windowSize.innerHeight * ratio + "px"),
                            ...
                            (contentHeight = content.offsetHeight),
                            (contentWidth = content.offsetWidth)),
                          contentWidth > windowSize.innerWidth * ratio && ((content.style.width = windowSize.innerWidth * ratio + "px"), (content.style.height = contentHeight * ((windowSize.innerWidth * ratio) / contentWidth) + "px")),
        ...
        addCoupon: function(coupon) {
          for (
            var couponListNodes = this.orderBlockNode.querySelectorAll(".bx-soa-coupon:not(.bx-soa-coupon-item-fixed) .bx-soa-coupon-item"), i = 0; i < couponListNodes.length && !couponListNodes[i].querySelector('[data-coupon="' + BX.util.htmlspecialchars(coupon) + '"]'); i++
          )
            couponListNodes[i].appendChild(this.getCouponNode({
              text: coupon
            }, !0, "bx-soa-coupon-item-danger"));
        },
        ...
        editRegionBlock: function(active) {
          this.regionBlockNode &&
            ...
            (active ? (this.editActiveRegionBlock(!0), !this.regionBlockNotEmpty && this.editFadeRegionBlock()) : this.editFadeRegionBlock(), (this.initialized.region = !0));
        },
        editActiveRegionBlock: function(activeNodeMode) {
          ...
          this.initialized.region ||
            ((regionContent = node.querySelector(".bx-soa-section-content")) ? BX.cleanNode(regionContent) : ((regionContent = this.getNewContainer()), node.appendChild(regionContent)),
              ...
              (this.regionBlockNotEmpty ?
                ...
                (BX.removeClass(this.regionBlockNode, "bx-active"), (this.regionBlockNode.style.display = "none"), (this.result.IS_AUTHORIZED && void 0 === this.result.LAST_ORDER_DATA.FAIL) || this.initFirstSection())),
        ...
        editFadeRegionContent: function(node) {
          if (node && this.locationsInitialized) {
            ...
            errorNode && node.appendChild(errorNode.cloneNode(!0)),
              ...
              ((validRegionErrors = this.isValidRegionBlock()).length ? BX.addClass(this.regionBlockNode, "bx-step-error") : BX.removeClass(this.regionBlockNode, "bx-step-error"));
          }
        },
        getSelectedPersonType: function() {
          ...
          if (
            (personTypeInput =
              1 == personTypeLength ?
              this.propsBlockNode.querySelector("input[type=hidden][name=PERSON_TYPE]") :
              2 == personTypeLength ?
              this.propsBlockNode.querySelector("input[type=radio][name=PERSON_TYPE]:checked") :
              this.propsBlockNode.querySelector("select[name=PERSON_TYPE] > option:checked"))
          )
        ...
        getDeliveryLocationInput: function(node) {
          ...
          if ((location = this.locations[locationId]) && location[0] && location[0].output)
            for (k in ((this.regionBlockNotEmpty = !0),
                ...
                (insertedLoc = BX.create("DIV", {
                  ...
                  props: {
                    className: "form-group bx-soa-location-input-container soa-property-container"
                  },
                  style: {
                    visibility: "hidden"
                  },
          ...
          altProperty &&
            ...
            location && location[0] && node.appendChild(BX.create("DIV", {
              props: {
        ...
        getLocationString: function(node) {
          ...
          var locationInputNode = node.querySelector(".bx-ui-sls-route"),
            ...
            i,
            altLoc;
          if (locationInputNode && locationInputNode.value && locationInputNode.value.length) locationString = locationInputNode.value;
          else {
            for (i = (locationSteps = node.querySelectorAll(".bx-ui-combobox-fake.bx-combobox-fake-as-input")).length; i--;)
        ...
        getZipLocationInput: function(node) {
          ...
          for (i in this.result.ORDER_PROP.properties)
            if (this.result.ORDER_PROP.properties.hasOwnProperty(i) && "Y" == this.result.ORDER_PROP.properties[i].IS_ZIP) {
            ...
            if (personTypesCount > 2) {
              ...
              for (i in this.result.PERSON_TYPE)
                ...
                ((currentType = this.result.PERSON_TYPE[i]),
                  ...
                  node.appendChild(BX.create("DIV", {
                    props: {
                      className: "person-type" + ("Y" == currentType.CHECKED ? " active" : "")
                    },
                    children: [label]
                  })),
                  "Y" == currentType.CHECKED && (oldPersonTypeId = currentType.ID));
              ...
              for (i in this.result.PERSON_TYPE) this.result.PERSON_TYPE.hasOwnProperty(i) && node.appendChild(BX.create("INPUT", {
                props: {
                  type: "hidden",
                  name: "PERSON_TYPE",
        ...
        getProfilesControl: function(node) {
          var profilesLength = BX.util.object_keys(this.result.USER_PROFILES).length,
            ...
            input;
          if (profilesLength)
            if ("Y" === this.params.ALLOW_USER_PROFILES && (profilesLength > 1 || "Y" === this.params.ALLOW_NEW_PROFILE)) {
              ...
              for (i in this.result.USER_PROFILES)
                this.result.USER_PROFILES.hasOwnProperty(i) && "Y" === this.result.USER_PROFILES[i].CHECKED && node.appendChild(BX.create("INPUT", {
                  props: {
                    name: "PROFILE_ID",
                    type: "hidden",
                    value: this.result.USER_PROFILES[i].ID
        ...
        editActivePaySystemBlock: function(activeNodeMode) {
          var node = activeNodeMode ? this.paySystemBlockNode : this.paySystemHiddenBlockNode,
            paySystemContent,
            paySystemNode;
          1 === this.result.PAY_SYSTEM.length ? this.paySystemBlockNode.classList.add("hidden") : this.paySystemBlockNode.classList.remove("hidden"),
            this.initialized.paySystem ||
            (this.opened["bx-soa-paysystem"] || this.paySystemBlockNode.classList.add("bx-step-completed"),
              (paySystemContent = node.querySelector(".bx-soa-section-content")) ? BX.cleanNode(paySystemContent) : ((paySystemContent = this.getNewContainer()), node.appendChild(paySystemContent)),
            ...
            (activeNodeMode && this.initialized.paySystem) || this.getPaySystemCompactInfo();
        },
          ...
          if (this.result.PAY_SYSTEM && !(this.result.PAY_SYSTEM.length <= 0)) {
            var paySystemItemsContainer = BX.create("DIV", {
              ...
              paySystemItemsDescription = BX.create("DIV", {
                props: {
                  className: "col-sm-12 bx-soa-pp-company-description"
                }
              });
            for (i = 0; i < this.paySystemPagination.currentPage.length; i++)
              ...
              "Y" == this.paySystemPagination.currentPage[i].CHECKED && (paySystemItemsDescription.innerHTML = this.paySystemPagination.currentPage[i].DESCRIPTION);
          ...
          return (
            (labelNodes = [
              ...
              BX.create("LABEL", {
                ...
                html: "<span>" +
                  ("N" != this.params.SHOW_PAY_SYSTEM_LIST_NAMES ? item.NAME : item.OWN_NAME) +
                  "</span>" +
                  (this.uniqueText(item.DESCRIPTION) ? "<div class='hint colored_theme_hover_bg-block'><span class='icon colored_theme_hover_bg-el'><i>?</i></span><div class='tooltip'>" + item.DESCRIPTION + "</div></div>" : ""),
                events: {
            ...
            (injectNode = BX.create("DIV", {
              props: {
                className: "bx-soa-pp-company-inject clearfix hidden"
              },
              html: ""
            })),
            ...
            (itemNode = BX.create("DIV", {
              props: {
                className: "bx-soa-pp-company bx-soa-pp-company-item col-lg-4 col-sm-6 col-xs-12"
              },
        ...
        editPaySystemInfo: function(paySystemNode) {
          if (this.result.PAY_SYSTEM && (0 != this.result.PAY_SYSTEM.length || "Y" == this.result.PAY_FROM_ACCOUNT)) {
            ...
            BX.cleanNode(paySystemInfoContainer),
              ...
              paySystemInfoContainer.appendChild(BX.create("DIV", {
                props: {
                  className: "bx-soa-pp-company"
                },
                children: [innerPs, delimiter, extPs]
              }));
            var injectNodes = BX.findChildren(this.paySystemBlockNode, {
                className: "bx-soa-pp-company-inject"
              }, !0),
              paySystemNode;
            if (injectNodes && injectNodes.length)
              for (var i = 0; i < injectNodes.length; ++i) BX.addClass(injectNodes[i], "hidden"), BX.cleanNode(injectNodes[i]);
            if (currentPaySystem)
              if ((paySystemNode = BX.findChildren(this.paySystemBlockNode, {
                  className: "bx-soa-pp-company",
                  attribute: {
                    "data-id": currentPaySystem.ID
                  }
                }, !0)) && paySystemNode.length) {
                var injectNode = BX.findChildren(paySystemNode[0], {
                  className: "bx-soa-pp-company-inject"
                }, !0);
          ...
          if (this.result.CURRENT_BUDGET_FORMATED && this.result.PAY_CURRENT_ACCOUNT && this.result.INNER_PAY_SYSTEM) {
            ...
            return (
              ...
              (subTitle = BX.create("DIV", {
                props: {
                  className: "filter label_block" + (isSelected ? " checked" : "")
                },
        ...
        editFadePaySystemContent: function(node) {
          ...
          errorNode ? node.appendChild(errorNode.cloneNode(!0)) : this.getErrorContainer(node),
            ...
            this.isSelectedInnerPayment() || (selectedPaySystem && selectedPaySystem.NAME) || (addedHtml = "<strong>" + BX.message("SOA_PS_SELECT_ERROR") + "</strong>");
        },
        getSelectedPaySystem: function() {
          var paySystemCheckbox = this.paySystemBlockNode.querySelector("input[name=PAY_SYSTEM_ID]:checked"),
            ...
            i;
          if (
            (paySystemCheckbox || (paySystemCheckbox = this.paySystemHiddenBlockNode.querySelector("input[name=PAY_SYSTEM_ID]:checked")),
              paySystemCheckbox || (paySystemCheckbox = this.paySystemHiddenBlockNode.querySelector("input[type=hidden][name=PAY_SYSTEM_ID]")),
              paySystemCheckbox)
          )
        ...
        selectPaySystem: function(event) {
          if (this.orderBlockNode && event) {
            var target = event.target || event.srcElement,
              ...
              innerPsAction = BX.hasClass(target, "bx-soa-pp-inner-ps") ? target : BX.findParent(target, {
            ...
            if (innerPsAction)
              ...
              innerPaySystemCheckbox.checked ? (BX.removeClass(innerPaySystemSection, "bx-selected"), (innerPaySystemCheckbox.checked = !1)) : (BX.addClass(innerPaySystemSection, "bx-selected"), (innerPaySystemCheckbox.checked = !0));
              ...
              innerPaySystemCheckbox && innerPaySystemCheckbox.checked && fullPayFromInnerPaySystem ?
                (BX.addClass(actionSection, "bx-selected"),
                  ((actionInput = actionSection.querySelector("input.bx-soa-pp-company-checkbox")).checked = !0),
                ...
                ((selectedSection = this.paySystemBlockNode.querySelector(".bx-soa-pp-company.bx-selected")),
                  BX.addClass(actionSection, "bx-selected"),
                  ((actionInput = actionSection.querySelector("input.bx-soa-pp-company-checkbox")).checked = !0),
                  selectedSection && (BX.removeClass(selectedSection, "bx-selected"), (selectedSection.querySelector("input.bx-soa-pp-company-checkbox").checked = !1)));
            }
            this.sendRequest();
          }
        },
        ...
        editActiveDeliveryBlock: function(activeNodeMode) {
          var node = this.deliveryBlockNode,
            deliveryContent,
            deliveryNode;
          this.result.IS_AUTHORIZED && !this.opened[this.deliveryBlockNode.id] && ((this.opened[this.deliveryBlockNode.id] = !0), BX.removeClass(this.deliveryBlockNode, "bx-selected")),
            this.initialized.delivery ||
            (this.opened[this.deliveryBlockNode.id] || this.deliveryBlockNode.classList.add("bx-step-completed"),
              (deliveryContent = node.querySelector(".bx-soa-section-content")) ? BX.cleanNode(deliveryContent) : ((deliveryContent = this.getNewContainer()), node.appendChild(deliveryContent)),
              ...
              "Y" !== this.params.HIDE_ORDER_DESCRIPTION && this.editPropsComment(deliveryNode),
        ...
        showPropInDelivery: function(propCode, node, title) {
          ...
          for (;
            (group = groupIterator());)
            for (propsIterator = group.getIterator();
              (property = propsIterator());) property.getSettings().CODE === propCode && (this.getPropertyRowNode(property, $propInner, !1, !1), (isAddProp = !0));
          ...
          if (this.result.DELIVERY) {
            ...
            BX.cleanNode(deliveryInfoContainer),
              ...
              ((extraServicesNode = BX.create("DIV", {
                  props: {
                    className: "bx-soa-pp-company-item col-md-6"
                  },
                  children: extraServices
                })),
                deliveryNode.appendChild(BX.create("DIV", {
                  props: {
                    className: "col-md-12 bx-soa-extraservices"
                  },
            ...
            var injectNodes = BX.findChildren(this.deliveryBlockNode, {
                className: "bx-soa-pp-company-inject"
              }, !0),
              deliveryNode;
            if (injectNodes && injectNodes.length)
            ...
            if ((deliveryNode = BX.findChildren(this.deliveryBlockNode, {
                className: "bx-soa-pp-company",
                attribute: {
                  "data-id": currentDelivery.ID
                }
              }, !0)) && deliveryNode.length) {
              var injectNode = BX.findChildren(deliveryNode[0], {
                className: "bx-soa-pp-company-inject"
              }, !0);
        ...
        getDeliveryPriceNodes: function(delivery) {
          ...
          return (priceNodesArray =
            void 0 !== delivery.DELIVERY_DISCOUNT_PRICE && parseFloat(delivery.DELIVERY_DISCOUNT_PRICE) != parseFloat(delivery.PRICE) ?
            parseFloat(delivery.DELIVERY_DISCOUNT_PRICE) > parseFloat(delivery.PRICE) ?
            [delivery.DELIVERY_DISCOUNT_PRICE_FORMATED] :
            [delivery.DELIVERY_DISCOUNT_PRICE_FORMATED, BX.create("BR"), BX.create("SPAN", {
              props: {
                className: "bx-price-old"
              },
        ...
        getDeliveryExtraServices: function(delivery) {
          ...
          for (i in (delivery.EXTRA_SERVICES.length && extraServices.push(BX.create("div", {
            ...
            if (delivery.EXTRA_SERVICES.hasOwnProperty(i) && (currentService = delivery.EXTRA_SERVICES[i]).canUserEditValue) {
              if (-1 == currentService.editControl.indexOf("this.checked"))
                ...
                (input = serviceNode.querySelector("input[type=text]")) || (input = serviceNode.querySelector("select")),
                input && BX.addClass(input, "form-control");
              else {
                let serviceID = currentService.editControl.match(/name="(.+?)"/);
                serviceNode = BX.create("DIV", {
                  props: {
                    className: "form-group filter label_block"
                  },
                  children: [
        ...
        createDeliveryItem: function(item) {
          var checked = "Y" == item.CHECKED,
            ...
            labelNodes = [
              ...
              BX.create("LABEL", {
                ...
                html: "<span>" +
                  ("N" != this.params.SHOW_DELIVERY_PARENT_NAMES ? item.NAME : item.OWN_NAME) +
                  "</span>" +
                  (this.uniqueText(item.DESCRIPTION) && !checked ? "<div class='hint colored_theme_hover_bg-block'><span class='icon colored_theme_hover_bg-el'><i>?</i></span><div class='tooltip'>" + item.DESCRIPTION + "</div></div>" : ""),
                events: {
          ...
          item.PRICE >= 0 || void 0 !== item.DELIVERY_DISCOUNT_PRICE ?
            ((bHasPrice = !0),
              (costNode = BX.create("DIV", {
                ...
                html: '<div class="bx-soa-pp-list-termin" lang="ru">' +
                  this.params.MESS_PRICE +
                  ':</div><div class="bx-soa-pp-list-description" lang="ru">' +
                  (item.PRICE > 0 ? (void 0 !== item.DELIVERY_DISCOUNT_PRICE ? item.DELIVERY_DISCOUNT_PRICE_FORMATED : item.PRICE_FORMATED) : this.params.MESS_PRICE_FREE) +
                  "</div>",
              }))) :
            deliveryCached &&
            ...
            ((bHasPrice = !0),
              (costNode = BX.create("DIV", {
                ...
                html: '<div class="bx-soa-pp-list-termin" lang="ru">' +
                  this.params.MESS_PRICE +
                  ':</div><div class="bx-soa-pp-list-description" lang="ru">' +
                  (deliveryCached.PRICE > 0 ? (void 0 !== deliveryCached.DELIVERY_DISCOUNT_PRICE ? deliveryCached.DELIVERY_DISCOUNT_PRICE_FORMATED : deliveryCached.PRICE_FORMATED) : this.params.MESS_PRICE_FREE) +
                  "</div>",
              }))),
            (label = BX.create("DIV", {
              props: {
                className: "bx-soa-pp-company-graf-container properties" + (item.CALCULATE_ERRORS || (deliveryCached && deliveryCached.CALCULATE_ERRORS) ? " bx-bd-waring" : "")
              },
              children: labelNodes
            })),
            (descNode = BX.create("DIV", {
              props: {
                className: "bx-soa-pp-company-description " + (checked ? "" : "hidden")
              },
          ...
          bHasPeriod &&
            (periodNode = BX.create("DIV", {
              props: {
                className: "bx-soa-pp-delivery-period"
              },
          ...
          return (
            ...
            (calculateNode = BX.create("DIV", {
              props: {
                className: "bx-soa-pp-delivery-calculate"
              },
            ...
            (itemNode = BX.create("DIV", {
              props: {
                className: "bx-soa-pp-company bx-soa-pp-company-item" +
        ...
        editFadeDeliveryContent: function(node) {
          ...
          errorNode && errorNode.innerHTML ? node.appendChild(errorNode.cloneNode(!0)) : this.getErrorContainer(node),
            warningNode && warningNode.innerHTML && node.appendChild(warningNode.cloneNode(!0)),
            (selectedDelivery && selectedDelivery.NAME) || node.appendChild(BX.create("STRONG", {
        ...
        selectDelivery: function(event) {
          if (this.orderBlockNode) {
            var target = event.target || event.srcElement,
              ...
              actionSection = BX.hasClass(target, "bx-soa-pp-company-item") ? target : BX.findParent(target, {
            ...
            if (!actionCompany) {
              ...
              actionSection && ((actionInput = actionSection.querySelector("input[type=radio]")), BX.addClass(actionSection, "bx-selected"), (actionInput.checked = !0)),
                selectedSection && ((selectedInput = selectedSection.querySelector("input[type=radio]")), BX.removeClass(selectedSection, "bx-selected"), (selectedInput.checked = !1)),
        ...
        getSelectedDelivery: function() {
          var deliveryCheckbox = this.deliveryBlockNode.querySelector("input[type=radio][name=DELIVERY_ID]:checked"),
            ...
            i;
          if (
            (deliveryCheckbox || (deliveryCheckbox = this.deliveryHiddenBlockNode.querySelector("input[type=radio][name=DELIVERY_ID]:checked")),
              deliveryCheckbox || (deliveryCheckbox = this.deliveryHiddenBlockNode.querySelector("input[type=hidden][name=DELIVERY_ID]")),
              deliveryCheckbox)
          )
        ...
        activatePickUp: function(deliveryName) {
          this.pickUpBlockNode &&
            ...
            ((this.pickUpBlockNode.style.display = ""), BX.hasClass(this.pickUpBlockNode, "bx-active") || (BX.addClass(this.pickUpBlockNode, "bx-active"), (this.pickUpBlockNode.style.display = "")));
        },
        ...
        editPickUpBlock: function(active) {
          this.pickUpBlockNode &&
            ...
            ((this.initialized.pickup = !1), active ? this.editActivePickUpBlock(!0) : this.editFadePickUpBlock(), (this.initialized.pickup = !0));
        },
        editActivePickUpBlock: function(activeNodeMode) {
          ...
          if (this.initialized.pickup)
            "Y" === this.params.SHOW_NEAREST_PICKUP && this.maps && !this.maps.maxWaitTimeExpired && ((this.maps.maxWaitTimeExpired = !0), this.initPickUpPagination(), this.editPickUpList(!0), this.pickUpFinalAction()),
            this.maps && !this.pickUpMapFocused && ((this.pickUpMapFocused = !0), setTimeout(BX.proxy(this.maps.pickUpMapFocusWaiter, this.maps), 200));
          else {
            ...
            var pickUpListOuter = BX.create("DIV", {
              props: {
                className: "bx-soa-pickup-list-outer-wrap scrollblock"
              }
            });
        ...
        editFadePickUpContent: function(pickUpContainer) {
          var selectedPickUp = this.getSelectedPickUp(),
            ...
            imgSrc;
          selectedPickUp &&
            ("Y" == this.params.SHOW_STORES_IMAGES && (html += '<img src="' + (imgSrc = (logotype = this.getImageSources(selectedPickUp, "IMAGE_ID")).src_1x || this.defaultStoreLogo) + '" class="bx-soa-pickup-preview-img">'),
              (html += "<strong>" + BX.util.htmlspecialchars(selectedPickUp.TITLE) + "</strong>"),
              selectedPickUp.ADDRESS && (html += "<br><strong>" + BX.message("SOA_PICKUP_ADDRESS") + ":</strong> " + BX.util.htmlspecialchars(selectedPickUp.ADDRESS)),
              selectedPickUp.PHONE && (html += "<br><strong>" + BX.message("SOA_PICKUP_PHONE") + ":</strong> " + BX.util.htmlspecialchars(selectedPickUp.PHONE)),
              selectedPickUp.SCHEDULE && (html += "<br><strong>" + BX.message("SOA_PICKUP_WORK") + ":</strong> " + BX.util.htmlspecialchars(selectedPickUp.SCHEDULE)),
              selectedPickUp.DESCRIPTION && (html += "<br><strong>" + BX.message("SOA_PICKUP_DESC") + ":</strong> " + BX.util.htmlspecialchars(selectedPickUp.DESCRIPTION)));
        },
        ...
        getSelectedPickUp: function() {
          var pickUpInput = BX("BUYER_STORE"),
            ...
            stores,
            i;
          if (pickUpInput && !(currentPickUp = allStoresList[(pickUpId = pickUpInput.value)]) && (stores = this.getSelectedDelivery().STORE))
            for (i in stores)
        ...
        checkPickUpShow: function() {
          var currentDelivery = this.getSelectedDelivery(),
            name,
            stores;
          currentDelivery && currentDelivery.STORE && currentDelivery.STORE.length && (stores = this.getPickUpInfoArray(currentDelivery.STORE)),
            stores && stores.length ?
            ((name = "N" != this.params.SHOW_DELIVERY_PARENT_NAMES ? currentDelivery.NAME : currentDelivery.OWN_NAME),
        ...
        geoLocationSuccessCallback: function(result) {
          ...
          currentDelivery && currentDelivery.STORE && (activeStores = this.getPickUpInfoArray(currentDelivery.STORE)),
            activeStores && activeStores.length >= this.options.pickUpMap.minToShowNearestBlock && result && this.editPickUpRecommendList(result.geoObjects.get(0)),
            ...
            if (((this.mapsReady = !0), this.resizeMapContainers(), "Y" === this.params.SHOW_PICKUP_MAP && BX("pickUpMap"))) {
              ...
              if (activeStores && activeStores.length) {
                ...
                this.maps.initializePickUpMap(selected),
                  this.maps && !this.pickUpMapFocused && ((this.pickUpMapFocused = !0), setTimeout(BX.proxy(this.maps.pickUpMapFocusWaiter, this.maps), 200)),
                  "Y" === this.params.SHOW_NEAREST_PICKUP && this.maps.showNearestPickups(BX.proxy(this.geoLocationSuccessCallback, this), BX.proxy(this.geoLocationFailCallback, this)),
                  ...
                  setTimeout(
                    BX.proxy(function() {
                      BX("pickUpMap").appendChild(
                        BX.create("DIV", {
                          props: {
                            className: "yandex-map__mobile-opener"
                          },
                          events: {
                            click: BX.proxy(function(e) {
                              ...
                              isFullscreen($pickup) ?
                                ...
                                (this.maps.pickUpMap.container && this.maps.pickUpMap.container.enterFullscreen(), this.maps.pickUpMap.getDiv && this.maps.pickUpMap.getDiv().requestFullscreen()),
        ...
        resizeMapContainers: function() {
          ...
          resizeBy &&
            ...
            ((width = resizeBy.clientWidth),
              ...
              "Y" === this.params.SHOW_PICKUP_MAP && pickUpMapContainer && (pickUpMapContainer.style.height = height + "px"),
              "Y" === this.params.SHOW_MAP_IN_PROPS && propertyMapContainer && (propertyMapContainer.style.height = height + "px"));
        },
          ...
          if (this.pickUpPagination.currentPage && this.pickUpPagination.currentPage.length) {
            ...
            if (
              (buyerStoreInput && (selectedStore = buyerStoreInput.value),
                (recommendList = this.pickUpBlockNode.querySelector(".bx-soa-pickup-list.recommend")) || (recommendList = this.pickUpHiddenBlockNode.querySelector(".bx-soa-pickup-list.recommend")),
              ...
              for (i = 0; i < selectedDelivery.STORE.length; i++) selectedDelivery.STORE[i] == selectedStore && (found = !0);
            for (i = 0; i < this.pickUpPagination.currentPage.length; i++)
              ((currentStore = this.pickUpPagination.currentPage[i]).ID != selectedStore && 0 != parseInt(selectedStore) && found) || ((selectedStore = buyerStoreInput.value = currentStore.ID), (found = !0)),
            ...
            isNew
              ?
              ((container = this.pickUpHiddenBlockNode.querySelector(".bx_soa_pickup .bx-soa-pickup-list-outer-wrap")) || (container = this.pickUpBlockNode.querySelector(".bx-soa-pp-company-item")),
                container.insertBefore(BX.create("DIV", {
                  props: {
                    className: "bx-soa-title-subblock"
                  },
              ...
              ((container = this.pickUpBlockNode.querySelector(".bx-soa-pickup-list.main")), BX.insertAfter(pickUpList, container), BX.remove(container)),
        ...
        pickUpFinalAction: function() {
          var selectedDelivery = this.getSelectedDelivery(),
            deliveryChanged;
          selectedDelivery && ((deliveryChanged = this.lastSelectedDelivery !== parseInt(selectedDelivery.ID)), (this.lastSelectedDelivery = parseInt(selectedDelivery.ID))),
            deliveryChanged &&
            this.pickUpBlockNode.id !== this.activeSectionId &&
            (this.pickUpBlockNode.id !== this.activeSectionId && this.editFadePickUpContent(BX.lastChild(this.pickUpBlockNode)), BX.removeClass(this.pickUpBlockNode, "bx-step-completed")),
            this.maps && this.maps.pickUpFinalAction();
        },
        getStoreInfoHtml: function(currentStore) {
          var html = "";
          return (
            currentStore.PHONE && (html += '<div class="prop">' + BX.message("SOA_PICKUP_PHONE") + ": " + BX.util.htmlspecialchars(currentStore.PHONE) + "</div>"),
            currentStore.SCHEDULE && (html += '<div class="prop">' + BX.message("SOA_PICKUP_WORK") + ": " + BX.util.htmlspecialchars(currentStore.SCHEDULE) + "</div>"),
            html
          );
        },
                  ...
                  children: [
                    BX.create("DIV", {
                      ...
                      children: options.distance ?
                        [BX.util.htmlspecialchars(titleStore + " " + currentStore.ADDRESS), " ( ~" + options.distance + " " + BX.message("SOA_DISTANCE_KM") + " ) "] :
        ...
        editPickUpRecommendList: function(geoLocation) {
          if (this.maps && this.maps.canUseRecommendList() && geoLocation) {
            ...
            for (i = 0; i < recommendedStoreIds.length; i++)
              ...
              0 === i && parseInt(selectedDelivery.ID) !== this.lastSelectedDelivery && (buyerStoreInput.value = parseInt(currentStoreId)),
              ...
              selectedDelivery.STORE_MAIN && selectedDelivery.STORE_MAIN.splice(selectedDelivery.STORE_MAIN.indexOf(currentStoreId), 1);
            (container = this.pickUpHiddenBlockNode.querySelector(".bx_soa_pickup .bx-soa-pickup-list-outer-wrap")) || (container = this.pickUpBlockNode.querySelector(".bx_soa_pickup .bx-soa-pickup-list-outer-wrap")),
        ...
        selectStore: function(event) {
          ...
          } else(target = event.target || event.srcElement), (storeItem = BX.hasClass(target, "bx-soa-pickup-list-item") ? target : BX.findParent(target, {
            className: "bx-soa-pickup-list-item"
          }));
          if (storeItem && storeInput) {
            ...
            ((selectedPickUp.querySelector(".bx-soa-pickup-l-item-btn .btn").innerText = this.params.MESS_SELECT_PICKUP), BX.removeClass(selectedPickUp, "bx-selected")),
        ...
        editActivePropsBlock: function(activeNodeMode) {
          var node = activeNodeMode ? this.propsBlockNode : this.propsHiddenBlockNode,
            ...
            i,
            validationErrors;
          this.opened[this.propsBlockNode.id] && (this.propsBlockNode.classList.remove("bx-step-completed"), this.propsBlockNode.classList.remove("bx-selected")),
            this.initialized.props ?
            this.maps && setTimeout(BX.proxy(this.maps.propsMapFocusWaiter, this.maps), 200) :
            (this.result.IS_AUTHORIZED || this.opened[this.propsBlockNode.id] || (this.opened[this.propsBlockNode.id] = !0),
              this.opened[this.propsBlockNode.id] || this.propsBlockNode.classList.add("bx-step-completed"),
              (propsContent = node.querySelector(".bx-soa-section-content")) ? BX.cleanNode(propsContent) : ((propsContent = this.getNewContainer()), node.appendChild(propsContent)),
        ...
        showFirstProps: function() {
          this.checkEmptyProps() ?
            ((this.opened[this.propsBlockNode.id] = !0), this.propsBlockNode.classList.remove("bx-step-completed"), this.propsBlockNode.classList.remove("bx-selected")) :
            this.opened[this.propsBlockNode.id] && !this.opened.edit_profile && ((this.opened[this.propsBlockNode.id] = !1), this.propsBlockNode.classList.add("bx-step-completed"));
        },
          ...
          if (!propsErrors.length)
            if (
              ...
              BX.ajax({
                ...
                onsuccess: BX.delegate(function(result) {
                  this.endLoader(),
                    result.profileID && ((this.opened[this.propsBlockNode.id] = !1), (this.opened.edit_profile = !1), this.showTempProfileInput(result), this.sendRequest("", {
                      "change-profile": "Y"
                    })),
        ...
        showPropItem: function(profile) {
          ...
          const checked = profile ? profile.CHECKED : "Y",
            ...
            labelNodes = [
              BX.create("INPUT", {
                ...
                events: {
                  change: BX.delegate(this.selectProfile, this)
                },
              }),
              BX.create("LABEL", {
                props: {
          ...
          if (
            (profile && this.result.USER_PROFILES_PROPS && this.result.USER_PROFILES_PROPS[profile.ID] && this.result.USER_PROFILES_PROPS[profile.ID].EMAIL && (emailValue = this.result.USER_PROFILES_PROPS[profile.ID].EMAIL), emailValue)
          ) {
          ...
          let phoneValue = this.getInputValueForProp(propForPhone),
            changeProfile;
          if (
            (profile && this.result.USER_PROFILES_PROPS && this.result.USER_PROFILES_PROPS[profile.ID] && this.result.USER_PROFILES_PROPS[profile.ID].PHONE && (phoneValue = this.result.USER_PROFILES_PROPS[profile.ID].PHONE), phoneValue)
          ) {
          ...
          if (
            ("Y" === checked &&
              (changeProfile = BX.create("DIV", {
                ...
                events: {
                  click: BX.proxy(this.editProfile, this)
                },
              })),
              isBottomProps)
          ) {
        ...
        getPropByFilter: function(filter) {
          return this.result.ORDER_PROP && this.result.ORDER_PROP.properties && filter ?
        ...
        editFadePropsContent: function(node) {
          if (node && this.locationsInitialized) {
            var errorNode = this.propsHiddenBlockNode.querySelector(".alert"),
              ...
              validPropsErrors;
            errorNode && node.appendChild(errorNode.cloneNode(!0)),
              personType && ((fadeParamName = "PROPS_FADE_LIST_" + personType.ID), (props = this.params[fadeParamName])),
              !props || props.length,
        ...
        editPropsItems: function(propsNode) {
          if (this.result.ORDER_PROP && this.propertyCollection) {
            for (
              var propsItemsContainer, propsInnerWrapper = BX.create("div", {
                props: {
                  className: "row row-props group-without-margin"
                }
          ...
          switch (
            (disabled ?
              ...
              (BX.addClass(propsItemNode, "bx-soa-customer-field form-group"),
                ...
                propertyDesc.length && "STRING" != propertyType && "NUMBER" != propertyType && "DATE" != propertyType && (textHtml += " <small>(" + BX.util.htmlspecialchars(propertyDesc) + ")</small>"),
                (label = BX.create("LABEL", {
                  attrs: {
        ...
        insertLocationProperty: function(property, propsItemNode, disabled) {
          ...
          if (property.getId() in this.locations)
            if (disabled) {
              if ((propRow = this.propsHiddenBlockNode.querySelector('[data-property-id-row="' + property.getId() + '"]')))
                for (propNodes = propRow.querySelectorAll("div.bx-soa-loc"), i = 0; i < propNodes.length; i++)
                  (locationString = this.getLocationString(propNodes[i])), values.push(locationString.length ? BX.util.htmlspecialchars(locationString) : BX.message("SOA_NOT_SELECTED"));
              propsItemNode.innerHTML += values.join("<br>");
            } else {
              for (propContainer = BX.create("DIV", {
                  props: {
                    className: "soa-property-container"
                  }
                }), propRow = this.locations[property.getId()], i = 0; i < propRow.length; i++)
                for (k in ((currentLocation = propRow[i] ? propRow[i].output : {}),
                    ...
                    property.isMultiple() && (insertedLoc.style.marginBottom = "search" == this.locationsTemplate ? "5px" : "20px"),
          ...
          if (
            (BX.hasClass(lastProp, "bx-soa-loc") &&
              ("search" == this.locationsTemplate ?
                (input = lastProp.querySelector("input[type=text][class=dropdown-field]")) && (index = parseInt(input.name.substring(input.name.indexOf("[") + 1, input.name.indexOf("]"))) + 1) :
                (input = lastProp.querySelectorAll("input[type=hidden]")).length && ((input = input[input.length - 1]), (index = parseInt(input.name.substring(input.name.indexOf("[") + 1, input.name.indexOf("]"))) + 1))),
            ...
            for (k in ((insertedLoc = BX.create("DIV", {
                  ...
                  style: {
                    marginBottom: "search" == this.locationsTemplate ? "5px" : "20px"
                  },
        ...
        insertFileProperty: function(property, propsItemNode, disabled) {
          ...
          if (disabled) {
            ...
            (saved = this.savedFilesBlockNode.querySelector('div[data-property-id-row="' + property.getId() + '"]')) && (propContainer = saved.querySelector("div.soa-property-container")),
            propContainer ?
            propsItemNode.appendChild(propContainer) :
            ((propContainer = BX.create("DIV", {
                props: {
        ...
        insertStringProperty: function(property, propsItemNode, disabled) {
          ...
          if (disabled) {
            if ((prop = this.propsHiddenBlockNode.querySelector('div[data-property-id-row="' + property.getId() + '"]'))) {
              if (((values = []), 0 == (inputs = prop.querySelectorAll("input[type=text]")).length && (inputs = prop.querySelectorAll("textarea")), inputs.length))
            ...
            propsItemNode.appendChild(propContainer),
            this.alterProperty(property.getSettings(), propContainer),
            "Y" === property.getSettings().IS_PHONE && this.bindValidationPhone(property.getId(), propContainer),
        ...
        insertEnumProperty: function(property, propsItemNode, disabled) {
          ...
          } else(propContainer = BX.create("DIV", {
            props: {
              className: "soa-property-container"
            }
          })), property.appendTo(propContainer), propsItemNode.appendChild(propContainer), this.bindValidation(property.getId(), propContainer);
        },
        ...
        alterProperty: function(settings, propContainer) {
          ...
          for (
            (textNode = propContainer.querySelector("input[type=text]")) || (textNode = propContainer.querySelector("textarea")),
            textNode &&
            ((textNode.id = "soa-property-" + settings.ID),
              ...
              "Y" == settings.IS_PHONE && (textNode.setAttribute("autocomplete", "tel"), textNode.classList.add("phone")),
          ...
          if ("FILE" == settings.TYPE) {
            if (settings.ACCEPT && settings.ACCEPT.length)
              for (fileInputs = propContainer.querySelectorAll("input[type=file]"), accepts = this.getFileAccepts(settings.ACCEPT), i = 0; i < fileInputs.length; i++) fileInputs[i].setAttribute("accept", accepts);
          ...
          for (add = propContainer.querySelectorAll("input[type=button]"), i = 0; i < add.length; i++)
            BX.addClass(add[i], "btn btn-default btn-sm"), ("Y" == settings.MULTIPLE && i == add.length - 1) || ("FILE" == settings.TYPE && (BX.prepend(add[i], add[i].parentNode), (add[i].style.marginRight = "10px")));
          add.length &&
                ...
                BX.delegate(function(e) {
                  ...
                  if (
                    (this.bindValidation(settings.ID, targetContainer),
                      add.length && add[add.length - 2] && (BX.prepend(add[add.length - 2], add[add.length - 2].parentNode), (add[add.length - 2].style.marginRight = "10px"), BX.addClass(add[add.length - 2], "btn btn-default btn-sm")),
                      del && BX.remove(del),
                      textInputs.length &&
                      ((textInputs[textInputs.length - 1].placeholder = settings.DESCRIPTION),
                        ...
                        settings.PATTERN && settings.PATTERN.length && textInputs[textInputs.length - 1].removeAttribute("pattern")),
                      textAreas.length && ((textAreas[textAreas.length - 1].placeholder = settings.DESCRIPTION), BX.addClass(textAreas[textAreas.length - 1], "form-control bx-ios-fix")),
                      "FILE" == settings.TYPE)
                  ) {
                    if (settings.ACCEPT && settings.ACCEPT.length)
                      for (fileInputs = propContainer.querySelectorAll("input[type=file]"), accepts = this.getFileAccepts(settings.ACCEPT), i = 0; i < fileInputs.length; i++) fileInputs[i].setAttribute("accept", accepts);
        ...
        isValidForm: function() {
          ...
          var regionErrors = this.isValidRegionBlock(),
            ...
            i;
          return (
            regionErrors.length && ((navigated = !0), this.animateScrollTo(this.deliveryBlockNode, 800, 50)),
            propsErrors.length &&
            !navigated &&
            setTimeout(
              BX.delegate(function() {
            ...
            ((this.deliveryBlockNode.querySelector(".alert.alert-danger").style.display = "none"), BX.cleanNode(this.deliveryBlockNode.querySelector(".alert.alert-danger")), BX.removeClass(this.deliveryBlockNode, "bx-step-error")),
            propsErrors.length ?
            (this.opened[this.propsBlockNode.id] || this.editProfile(), this.showError(this.propsBlockNode, propsErrors), BX.addClass(this.propsBlockNode, "bx-step-error")) :
            ((this.propsBlockNode.querySelector(".alert.alert-danger").style.display = "none"), BX.cleanNode(this.propsBlockNode.querySelector(".alert.alert-danger")), BX.removeClass(this.propsBlockNode, "bx-step-error")),
          ...
          for (i = 0; i < props.length; i++)
            ...
            ((propContainer = props[i].querySelector(".soa-property-container")) &&
              ((arProperty = this.validation.properties[id]),
                ...
                (propsErrors = propsErrors.concat(this.isValidProperty(data, !0, notShowError)))));
          return propsErrors;
        },
          ...
          if (tooltipId && targetNode && text) {
            ...
            tooltip
              ...
              ((tooltipInner = BX.create("DIV", {
                ...
                (quickLocation = targetNode.parentNode.querySelector("div.quick-locations")) && (targetNode = quickLocation),
        ...
        validateString: function(input, arProperty, fieldName) {
          ...
          return "Y" === arProperty.MULTIPLE ?
            ...
            ("Y" === arProperty.REQUIRED && 0 === value.length && errors.push(field + " " + BX.message("SOA_REQUIRED")),
              value.length &&
              (arProperty.MINLENGTH && arProperty.MINLENGTH > value.length && errors.push(BX.message("SOA_MIN_LENGTH") + ' "' + name + '" ' + BX.message("SOA_LESS") + " " + arProperty.MINLENGTH + " " + BX.message("SOA_SYMBOLS")),
                arProperty.MAXLENGTH && arProperty.MAXLENGTH < value.length && errors.push(BX.message("SOA_MAX_LENGTH") + ' "' + name + '" ' + BX.message("SOA_MORE") + " " + arProperty.MAXLENGTH + " " + BX.message("SOA_SYMBOLS")),
        ...
        validateLocation: function(input, arProperty, fieldName) {
          ...
          return "Y" == arProperty.MULTIPLE && "Y" !== arProperty.IS_LOCATION ?
            errors :
            ("Y" != arProperty.REQUIRED || (0 != value.length && value != BX.message("SOA_NOT_SPECIFIED")) || errors.push(field + " " + BX.message("SOA_REQUIRED")), errors);
        },
          ...
          return "Y" == arProperty.MULTIPLE ?
            ...
            ("Y" == arProperty.REQUIRED && 0 == value.length && errors.push(field + " " + BX.message("SOA_REQUIRED")),
              ...
              (/[0-9]|\./.test(value) || errors.push(field + " " + BX.message("SOA_NOT_NUMERIC")),
                arProperty.MIN && parseFloat(arProperty.MIN) > parseFloat(value) && errors.push(BX.message("SOA_MIN_VALUE") + ' "' + name + '" ' + parseFloat(arProperty.MIN)),
                arProperty.MAX && parseFloat(arProperty.MAX) < parseFloat(value) && errors.push(BX.message("SOA_MAX_VALUE") + ' "' + name + '" ' + parseFloat(arProperty.MAX)),
                arProperty.STEP &&
                parseFloat(arProperty.STEP) > 0 &&
                (del = ((num = Math.abs(parseFloat(value) - (arProperty.MIN && parseFloat(arProperty.MIN) > 0 ? parseFloat(arProperty.MIN) : 0))) / parseFloat(arProperty.STEP)).toPrecision(12)) != parseInt(del) &&
        ...
        validateFile: function(inputs, arProperty, fieldName) {
          ...
          if ("Y" != arProperty.REQUIRED || 0 != files.length || "" != defaultValue || (arProperty.DEFAULT_VALUE && arProperty.DEFAULT_VALUE.length))
            for (i = 0; i < files.length; i++)
              ...
              (fileExtension = (splittedName = file.name.split(".")).length > 1 ? splittedName[splittedName.length - 1].toLowerCase() : ""),
              ...
              file.size > parseInt(arProperty.MAXSIZE) && errors.push(BX.message("SOA_MAX_SIZE") + ' "' + fileName + '" (' + this.getSizeString(arProperty.MAXSIZE, 1) + ")");
          ...
          if (this.totalInfoBlockNode && this.result.TOTAL) {
            ...
            if (
              (BX.cleanNode(this.totalInfoBlockNode),
                this.fixStikerBlock(),
                0 === parseFloat(total.ORDER_PRICE) ? ((priceHtml = this.params.MESS_PRICE_FREE), (params.free = !0)) : (priceHtml = total.ORDER_PRICE_FORMATED),
                ...
                (this.totalInfoBlockNode.appendChild(this.createTotalUnit(BX.message("SOA_SUM_IT"), total.ORDER_TOTAL_LEFT_TO_PAY_FORMATED, {
                  ...
                  this.totalInfoBlockNode.appendChild(this.createTotalUnit(BX.message("SOA_SUM_PAYED"), '<span class="payed">' + total.PAYED_FROM_ACCOUNT_FORMATED + "</span>"))) :
                ...
                (this.totalInfoBlockNode.appendChild(this.createTotalUnit(BX.message("ORDER_ITEMS_TITLE") + ", " + total.ITEMS_COUNT + BX.message("ORDER_MEASURE_TITLE"), total.ITEMS_SUMM, params)),
                  this.totalInfoBlockNode.appendChild(
                    this.createTotalUnit(BX.message("ORDER_SERVICES_TITLE") + ", " + this.result.SERVICES_ITEMS.COUNT + BX.message("ORDER_MEASURE_TITLE"), this.result.SERVICES_ITEMS.SUMM_FORMATTED, params)
                  )) :
                ((totalName = BX.message("SOA_SUM_SUMMARY")), this.totalInfoBlockNode.appendChild(this.createTotalUnit(BX.message("SOA_SUM_SUMMARY"), priceHtml, params))),
                this.options.showOrderWeight && this.totalInfoBlockNode.appendChild(this.createTotalUnit(BX.message("SOA_SUM_WEIGHT_SUM"), total.ORDER_WEIGHT_FORMATED)),
                this.options.showTaxList)
            )
              for (i = 0; i < total.TAX_LIST.length; i++)
                (valFormatted = total.TAX_LIST[i].VALUE_MONEY_FORMATED || ""),
                this.totalInfoBlockNode.appendChild(this.createTotalUnit(total.TAX_LIST[i].NAME + (total.TAX_LIST[i].VALUE_FORMATED ? " " + total.TAX_LIST[i].VALUE_FORMATED : "") + ":", valFormatted));
            if (
              ((params = {}),
                (deliveryError = (curDelivery = this.getSelectedDelivery()) && curDelivery.CALCULATE_ERRORS && curDelivery.CALCULATE_ERRORS.length) ?
                ...
                // this.result.DELIVERY.length && this.totalInfoBlockNode.appendChild(this.createTotalUnit(BX.message("SOA_SUM_DELIVERY"), deliveryValue, params)),
                // this.options.showDiscountPrice &&
                // ((discText = this.params.MESS_ECONOMY),
                //   total.DISCOUNT_PERCENT_FORMATED && parseFloat(total.DISCOUNT_PERCENT_FORMATED) > 0 && (discText += total.DISCOUNT_PERCENT_FORMATED),
                //   this.totalInfoBlockNode.appendChild(this.createTotalUnit(discText + ":", total.DISCOUNT_PRICE_FORMATED, {
                //     highlighted: !0
                //   }))),
                // parseFloat(total.PAY_SYSTEM_PRICE) >= 0 && this.result.DELIVERY.length && this.totalInfoBlockNode.appendChild(this.createTotalUnit(BX.message("SOA_PAYSYSTEM_PRICE"), "~" + total.PAY_SYSTEM_PRICE_FORMATTED)),
                !this.result.SHOW_AUTH)
            ) {
              "Y" === this.params.SHOW_COUPONS && this.editCoupons(this.totalInfoBlockNode),
                    ...
                    children: [
                      BX.create("A", {
                        props: {
                          ...
                          className: "btn btn-default btn-lg btn-order-save order-disabled"
                        },
              ...
              if ("Y" == arAsproOptions.THEME.SHOW_LICENCE) {
                conditions.push(BX.create("span", {
              ...
              if ("Y" == arAsproOptions.THEME.SHOW_OFFER) {
                "Y" == arAsproOptions.THEME.SHOW_LICENCE && conditions.push(BX.create("span", {
              ...
              conditions.length > 0 &&
                (conditions.unshift(BX.create("span", {
                  ...
                  .appendChild(BX.create("DIV", {
                    ...
                    children: [BX.create("div", {
                      ...
                      // children: conditions
                      children: '<span>Согласен с <a href=\"/\">политикой конфиденциальности</a> и <a href=\"/\">пользовательским соглашением</a></span>'
                    })]
                  })));
            }
        ...
        editMobileTotalBlock: function() {
          this.result.SHOW_AUTH ? BX.removeClass(this.mobileTotalBlockNode, "visible-xs") : BX.addClass(this.mobileTotalBlockNode, "visible-xs"),
        ...
        showTotalDeliveryInfo: function() {
          ...
          if (curDelivery && (this.totalInfoBlockNode.appendChild(this.createTotalScrollInfo(BX.message("ORDER_TOTAL_DELIVERY_TITLE"), curDelivery.NAME, this.deliveryBlockNode)), curDelivery.PERIOD_TEXT)) {
            ...
            this.totalInfoBlockNode.appendChild(BX.create("div", {
              props: {
                className: "total-delivery-info font_xs"
              },
        ...
        createTotalScrollInfo: function(name, info, block) {
          return BX.create("div", {
            props: {
              className: "total-scroll-info font_sm"
            },
            children: [
              BX.create("div", {
                props: {
                  className: "total-scroll-info__title"
                },
                text: name + ":"
              }),
              BX.create("div", {
                props: {
                  className: "total-scroll-info__value" + (block.classList.contains("hidden") ? " " : " colored_theme_text_with_hover wborder")
                },
                html: "<span>" + info + "</span>",
                events: {
        ...
        basketBlockScrollCheckEvent: function(e) {
          ...
          0 == scrollLeft ? BX.removeClass(parent, "bx-soa-table-fade-left") : BX.addClass(parent, "bx-soa-table-fade-left"),
            0 == scrollRight ? BX.removeClass(parent, "bx-soa-table-fade-right") : BX.addClass(parent, "bx-soa-table-fade-right");
        },
        basketBlockScrollCheck: function() {
          ...
          for (i = 0; i < scrollableNodes.length; i++)
            ...
            ((scrollLeft = (scrollNode = BX.firstChild(parentNode)).scrollLeft),
              ...
              0 == scrollLeft ? BX.removeClass(parentNode, "bx-soa-table-fade-left") : BX.addClass(parentNode, "bx-soa-table-fade-left"),
              0 == scrollRight ? BX.removeClass(parentNode, "bx-soa-table-fade-right") : BX.addClass(parentNode, "bx-soa-table-fade-right"),
        ...
        totalBlockScrollCheck: function() {
          if (this.totalInfoBlockNode && this.totalGhostBlockNode) {
            ...
            headerFixed && BX.hasClass(headerFixed, "fixed") && (offset = headerFixed.offsetHeight + 20),
              ghostBottom - this.totalBlockNode.offsetHeight < scrollTop + 20 ? BX.addClass(this.totalInfoBlockNode, "bx-soa-cart-total-bottom") : BX.removeClass(this.totalInfoBlockNode, "bx-soa-cart-total-bottom"),
              ...
              (BX.removeClass(this.totalInfoBlockNode, "bx-soa-cart-total-fixed"), (this.totalGhostBlockNode.style.paddingTop = 0), (this.totalInfoBlockNode.style.width = ""));
          }
        },
        ...
        totalBlockFixFont: function() {
          ...
          totalNode && ((target = BX.lastChild(totalNode)), objList.push({
            ...
            ((target = BX.lastChild(buttonNode)), objList.push({
              node: target,
              maxFontSize: 18,
              smallestValue: !1
            })),
            objList.length && BX.FixFontSize.init({
              objList: objList,
              onAdaptiveResize: !0
            });
        },
