		...
		<div class="flexbox flexbox--row">
			...
			<div class="product-main">
				...
				<div class="flexbox flexbox--row flex-wrap align-items-normal <?= !$bShowPropsBlock ? 'justify-center' : '' ?>">
					<? if ($bShowPropsBlock) : ?>
						<div class="product-chars flex-65">
									...
									<div class="full-price-block">
										...
										<?*/ ?>
											...
											<div class="prices_block">
												...
												<span class="sum-price"><b><?= GetMessage("TITLE_TOTAL_PRICE") ?></b><span id="total-price"><?= GetMessage("TITLE_TOTAL_COUNT") ?></span><?= GetMessage("CURRENCY_TOTAL_COUNT") ?></span>
