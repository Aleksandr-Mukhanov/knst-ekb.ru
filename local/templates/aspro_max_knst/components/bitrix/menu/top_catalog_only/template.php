        ...
        <table>
            <tr>
                <? foreach ($arResult as $arItem) : ?>
                    <? $bShowChilds = $arParams["MAX_LEVEL"] > 0;
                    ...
                    <td class="menu-item <?= ($arItem["CHILD"] ? "dropdown" : "") ?> <?= ($bWideMenu ? 'wide_menu' : ''); ?> <?= (isset($arItem["PARAMS"]["CLASS"]) ? $arItem["PARAMS"]["CLASS"] : ""); ?>  <?= ($arItem["SELECTED"] ? "active" : "") ?>">
                        <div class="wrap">
                            <a class="<?= ($arItem["CHILD"] && $bShowChilds ? "dropdown-toggle" : "") ?>" href="<?= $arItem["LINK"] ?>">
                                <div class="menu_blue_custom">
                                    <i class="svg inline  svg-inline-icon_catalog" aria-hidden="true">
                                        <?= CMax::showIconSvg("hamburger_white", SITE_TEMPLATE_PATH . '/images/svg/hamburger_white.svg', '', ''); ?>
                                    </i>
                                    <?= $arItem["TEXT"] ?>
                                                    ...
                                                    <div class="menu-navigation__sections">
                                                        <? foreach ($arItem["CHILD"] as $arChild) : ?>
                                                            <div class="menu-navigation__sections-item<?= ($arChild['SELECTED'] ? " active" : ""); ?>">
                                                                ...
                                                                <a href="<?= $arChild['LINK'] ?>" class="menu-navigation__sections-item-link font_mlg <?= ($arChild["SELECTED"] ? "colored_theme_text" : "dark_link") ?> <?= ($bShowImg ? " menu-navigation__sections-item-link--image" : ""); ?><?= ($arChild['CHILD'] ? " menu-navigation__sections-item-dropdown" : ""); ?>">
