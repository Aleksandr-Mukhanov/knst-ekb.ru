...
?>
    ...
    <div class="menu-modal">
        ...
        <nav class="menu-modal__nav">
            <ul>
				<li class="active"><a href="/help/payment/">Оплата</a></li>
        ...
        <div class="menu-modal__bottom">
            ...
            <div class="header__contacts">
                <div class="header__phone"><a href="tel:88003011341">8 800 301 13 41</a></div>
                <div class="header__callback"><a href="#" data-event="jqm" data-param-form_id="CALLBACK" data-name="callback">заказать звонок</a></div>
            </div>
        </div>
    ...
    <header class="header">
        <div class="wrap">
            <div class="header__top">
                ...
                <div class="header__contacts">
                    <div class="header__phone"><a href="tel:88003011341">8 800 301 13 41</a></div>
                    <div class="header__callback"><a href="#" data-event="jqm" data-param-form_id="CALLBACK" data-name="callback">заказать звонок</a>
                    </div>
                </div>
            ...
            <div class="header__bottom">
                ...
                <div class="personal">
                    <a href="#" data-event="jqm" data-param-form_id="PRICE_CALC" data-name="PRICE_CALC" onclick="goModalCustom()"><i data-event="jqm" data-param-form_id="PRICE_CALC" data-name="PRICE_CALC" onclick="goModalCustom()" data-svg="<?= SITE_TEMPLATE_PATH; ?>/images/svg/icons/doc.svg"></i></a>
                    <a href="/basket/">
                        <?/*$APPLICATION->IncludeComponent(
