...
$modulePath = "/local/modules/imarket_catalog_app";
$modulePlace = 'local/modules';
...
if ($GLOBALS["install_step"] < 2) {
    ...
    <p><strong>Укажите инфоблок каталога</strong></p>
    <form action="<?=$APPLICATION->GetCurPage()?>" name="form1">
        <?=bitrix_sessid_post()?>
        <input type="hidden" name="lang" value="<?=LANGUAGE_ID?>" />
        <input type="hidden" name="id" value="imarket_catalog_app" />
